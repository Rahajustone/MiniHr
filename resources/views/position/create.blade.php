        ...
        <div class="d-flex justify-content-between flex-wrap">
            <div class="d-flex align-items-end flex-wrap">
                <div class="d-flex">
                    ...
                    <p class="text-primary hover-cursor">Create Position</p>
                </div>
            </div>
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('position.store')}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="exampleInputName1">Position Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Position Name" name="name" required value="{{ old('name') }}">
                    </div>
                    <div class="form-group">
